...
class AdminAPIRouter(LoggerMixin):
    ...
    def __init__(self, token_manager, audit_logger):
    ...
    def _get_csrf_serializer(self) -> URLSafeTimedSerializer:
        ...
        if self._csrf_serializer is None:
            ...
            if hasattr(config, 'api_security') and config.api_security and config.api_security.bearer_token:
                ...
                self.logger.warning("Using auto-generated CSRF secret - configure api_security.bearer_token for persistence")
                ...
                if not keycloak_auth.verify_admin_role(user):
                    ...
                    return HTMLResponse(
                        ...
                        <body>
                            ...
                            <p>Required role: <code>darkfleet-admin</code></p>
...
def create_admin_router(token_manager, audit_logger) -> APIRouter:
    admin_api = AdminAPIRouter(token_manager, audit_logger)
